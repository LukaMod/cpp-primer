#ifndef EX_16_29_BLOB_H_
#define EX_16_29_BLOB_H_
...
template <typename T>
inline Blob<T>::Blob() : data(make_sharedptr<std::vector<T>>()) {}

template <typename T>
inline Blob<T>::Blob(std::initializer_list<T> il) : data(make_sharedptr<std::vector<T>>(il)) {}

template <typename T>
template <typename It>
inline Blob<T>::Blob(It b, It e) : data(make_sharedptr<std::vector<T>>(b, e)) {}
